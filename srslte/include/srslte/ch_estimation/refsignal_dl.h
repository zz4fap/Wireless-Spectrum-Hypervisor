...
// *****************************************************************************
SRSLTE_API int srslte_insert_refsignal_into_subframe(srslte_cell_t cell, uint32_t radio_nof_prb, uint32_t channel, uint32_t port_id, cf_t *pilots, cf_t *sf_symbols);

SRSLTE_API int srslte_insert_refsignal_into_subframe_with_dc(srslte_cell_t cell, uint32_t radio_fft_len, int dc_pos, uint32_t port_id, cf_t *pilots, cf_t *sf_symbols);
