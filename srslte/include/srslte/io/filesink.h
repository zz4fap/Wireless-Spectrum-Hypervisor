...
SRSLTE_API int filesink_init(srslte_filesink_t *q, char *filename, srslte_datatype_t type);

SRSLTE_API void filesink_free(srslte_filesink_t *q);

SRSLTE_API int filesink_write(srslte_filesink_t *q,
                                     cf_t *buffer,
                                     int nsamples);
