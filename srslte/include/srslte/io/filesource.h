...
SRSLTE_API int filesource_init(srslte_filesource_t *q, char *filename, srslte_datatype_t type);

SRSLTE_API void filesource_free(srslte_filesource_t *q);

SRSLTE_API int filesource_read(srslte_filesource_t *q, void *buffer, int nsamples);
