...
// *****************************************************************************
SRSLTE_API int srslte_encode_pdcch(srslte_pdcch_t *q, srslte_dci_msg_t *msg, srslte_dci_location_t location, uint16_t rnti, cf_t *sf_symbols[SRSLTE_MAX_PORTS], uint32_t nsubframe, uint32_t cfi, uint32_t radio_nof_prb, uint32_t channel);

SRSLTE_API int srslte_encode_and_map_pdcch_with_dc(srslte_pdcch_t *q, srslte_dci_msg_t *msg, srslte_dci_location_t location, uint16_t rnti, cf_t *sf_symbols[SRSLTE_MAX_PORTS], uint32_t nsubframe, uint32_t cfi, uint32_t radio_fft_len, int dc_pos);
