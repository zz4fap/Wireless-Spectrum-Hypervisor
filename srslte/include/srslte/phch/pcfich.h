...
// *****************************************************************************
SRSLTE_API int srslte_encode_pcfich(srslte_pcfich_t *q, uint32_t cfi, cf_t *slot_symbols[SRSLTE_MAX_PORTS], uint32_t subframe, uint32_t radio_nof_prb, uint32_t channel);

SRSLTE_API int srslte_encode_and_map_pcfich_with_dc(srslte_pcfich_t *q, uint32_t cfi, cf_t *slot_symbols[SRSLTE_MAX_PORTS], uint32_t subframe, uint32_t radio_fft_len, int dc_pos);
