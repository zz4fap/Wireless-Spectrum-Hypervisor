...
// *****************************************************************************
SRSLTE_API int srslte_encode_pbch(srslte_pbch_t *q, uint8_t bch_payload[SRSLTE_BCH_PAYLOAD_LEN], cf_t *slot1_symbols[SRSLTE_MAX_PORTS], uint32_t frame_idx, uint32_t radio_nof_prb, uint32_t channel);

SRSLTE_API int srslte_insert_pbch_into_subframe(cf_t *pbch, cf_t *slot1_data, srslte_cell_t cell, uint32_t radio_nof_prb, uint32_t channel);

SRSLTE_API int srslte_insert_pbch_cp_into_subframe(cf_t *input, cf_t *output, srslte_cell_t cell, uint32_t radio_nof_prb, uint32_t channel, bool put);
