...
SRSLTE_API int srslte_ue_dl_decode2(srslte_ue_dl_t *q, cf_t *input, uint8_t *data, uint32_t tti, uint32_t mcs);

SRSLTE_API int srslte_ue_dl_decode_rnti2(srslte_ue_dl_t *q, cf_t *input, uint8_t *data, uint32_t tti, uint16_t rnti, int mcs);
