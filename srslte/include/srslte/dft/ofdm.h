...
#define PREAMBLE_SLOT_SIZE_IN_SYMBOLS 2
...
// *****************************************************************************
SRSLTE_API void srslte_ofdm_tx_longer_sf(srslte_ofdm_t *q, cf_t *input, cf_t *output);

SRSLTE_API void srslte_ofdm_tx_preamble_slot(srslte_ofdm_t *q, cf_t *input, cf_t *output);

SRSLTE_API void srslte_ofdm_tx_sf_no_gb(srslte_ofdm_t *q, cf_t *input, cf_t *output);

SRSLTE_API void srslte_ofdm_tx_slot_no_gb(srslte_ofdm_t *q, cf_t *input, cf_t *output);

SRSLTE_API void srslte_ofdm_tx_longer_sf_no_gb(srslte_ofdm_t *q, cf_t *input, cf_t *output);

SRSLTE_API void srslte_ofdm_tx_preamble_slot_no_gb(srslte_ofdm_t *q, cf_t *input, cf_t *output);
