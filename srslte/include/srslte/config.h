...
// Flag used to enable the watchdog in the Hypervisor Tx, Hypervisor Rx and Synchronization threads.
#define ENABLE_WATCHDOG_TIMER 0

// Flag used to enable dropping of Tx messages sent by MAC when the Tx buffer is heavy loaded.
#define ENABLE_PACKET_DROPPING 0

// Flag used to enable threads like Tx/Rx to be stuck to specific CPU cores.
#define ENABLE_STICKING_THREADS_TO_CORES 0
