...
SRSLTE_API void srslte_insert_pss_into_subframe(cf_t *pss_signal, cf_t *slot, uint32_t radio_nof_prb, uint32_t nof_prb, uint32_t channel, srslte_cp_t cp);

SRSLTE_API void srslte_insert_pss_into_subframe_with_dc(cf_t *pss_signal, cf_t *slot, uint32_t radio_fft_len, int dc_pos, srslte_cp_t cp);

SRSLTE_API void srslte_insert_pss_into_subframe_with_dc2(cf_t *pss_signal, cf_t *slot, int lower_part_idx, int upper_part_idx);

SRSLTE_API void srslte_calculate_pss_lower_and_upper_indexes(uint32_t radio_fft_len, uint32_t vphy_fft_len, uint32_t channel, srslte_cp_t cp, int *lower_part_idx, int *upper_part_idx);

SRSLTE_API int srslte_pss_synch_init_fft_vphy(srslte_pss_synch_t *q, uint32_t frame_size, uint32_t fft_size, uint32_t vphy_id, uint32_t vphy_id_to_plot);

SRSLTE_API int srslte_pss_synch_init_fft_offset_vphy(srslte_pss_synch_t *q, uint32_t frame_size, uint32_t fft_size, int offset, uint32_t vphy_id, uint32_t vphy_id_to_plot);
