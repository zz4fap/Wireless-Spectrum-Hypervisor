...
SRSLTE_API int srslte_cfo_init_finer(srslte_cfo_t *h, uint32_t nsamples);

SRSLTE_API void srslte_cfo_free_finer(srslte_cfo_t *h);

SRSLTE_API void srslte_cfo_correct_finer(srslte_cfo_t *h, cf_t *input, cf_t *output, float freq);

SRSLTE_API void srslte_cfo_set_fft_size_finer(srslte_cfo_t *h, uint32_t size);

SRSLTE_API void srslte_cfo_set_tol_finer(srslte_cfo_t *h, float tol);
