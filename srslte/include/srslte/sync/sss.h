...
#define SRSLTE_HALF_SSS_LEN 31
#define SRSLTE_SSS_N        31
#define SRSLTE_SSS_LEN      2*SRSLTE_SSS_N

#define SRSLTE_HALF_SCH_LEN 31
...
// *****************************************************************************
SRSLTE_API void srslte_insert_sss_into_subframe(float *sss, cf_t *slot, uint32_t radio_nof_prb, uint32_t nof_prb, uint32_t channel, srslte_cp_t cp);

SRSLTE_API void srslte_insert_sss_into_subframe_with_dc(float *sss, cf_t *slot, uint32_t radio_fft_len, int dc_pos, srslte_cp_t cp);

SRSLTE_API void srslte_insert_sss_into_subframe_with_dc2(float *sss, cf_t *slot, int lower_part_idx, int upper_part_idx);

SRSLTE_API void srslte_calculate_sss_lower_and_upper_indexes(uint32_t radio_fft_len, int dc_pos, srslte_cp_t cp, int *lower_part_idx, int *upper_part_idx);
...
SRSLTE_API void srslte_insert_sch_into_subframe_with_dc_generic(float *sch, cf_t *slot, uint32_t radio_fft_len, int dc_pos, uint32_t symbol, bool contiguous_subcarriers);

SRSLTE_API void srslte_insert_sch_into_subframe_front_with_dc(float *sch, cf_t *slot, uint32_t radio_fft_len, uint32_t vphy_fft_len, int dc_pos);
