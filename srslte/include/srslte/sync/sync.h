...
#define ENABLE_DETECTION_DEBUGGING 0
...
// ********************************* McF-TDMA **********************************
//------------------------------------------------------------------------------
SRSLTE_API int srslte_sync_init_vphy(srslte_sync_t *q, uint32_t frame_size, uint32_t max_offset, uint32_t fft_size, uint32_t radio_id, int initial_subframe_index, bool decode_pdcch, uint32_t node_id, uint32_t vphy_id, bool phy_filtering, uint32_t vphy_id_to_plot);

// Finds a correlation peak in the input signal around position find_offset.
SRSLTE_API srslte_sync_find_ret_t srslte_sync_find_hyper_rx_frame_type_one(srslte_sync_t *q, cf_t *input, int find_offset, uint32_t *peak_position);

SRSLTE_API srslte_sync_find_ret_t srslte_sync_find_hyper_rx_frame_type_two(srslte_sync_t *q, cf_t *input, int find_offset, uint32_t *peak_position);

//******************************************************************************
//****************** Scatter system's customized functions *********************
//******************************************************************************
SRSLTE_API srslte_sync_find_ret_t srslte_sync_find_hyper_rx_frame_type_two_legacy(srslte_sync_t *q, cf_t *input, int find_offset, uint32_t *peak_position);

SRSLTE_API srslte_sync_find_ret_t srslte_sync_find_hyper_rx_frame_type_two_sch(srslte_sync_t *q, cf_t *input, int find_offset, uint32_t *peak_position);
