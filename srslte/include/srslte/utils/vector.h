...
// *****************************************************************************
SRSLTE_API void srslte_vec_power_spectrum_cf(cf_t *x, float *z, const float normalizationFactor, uint32_t len);

SRSLTE_API void srslte_vec_sc_prod_cfc_with_dc(const cf_t *x, const float h, cf_t *z, uint32_t nof_symb, uint32_t radio_fft_len, uint32_t vphy_fft_len, uint32_t vphy_nof_prb, uint32_t channel);

SRSLTE_API void srslte_vec_prod_cfc_with_dc(const cf_t *x, const float *y, cf_t *z, uint32_t nof_symb, uint32_t radio_fft_len, uint32_t vphy_fft_len, uint32_t vphy_nof_prb, uint32_t channel);

SRSLTE_API void srslte_vec_prod_cfc_with_dc_liq_window(const cf_t *x, const float *y, cf_t *z, uint32_t nof_symb, uint32_t radio_fft_len, uint32_t vphy_fft_len, uint32_t vphy_nof_prb, uint32_t channel, uint32_t gb_len);

SRSLTE_API void srslte_vec_sc_prod_cfc2(cf_t *x, float h, cf_t *z, uint32_t nof_symb, uint32_t nof_prb, uint32_t radio_nof_prb, uint32_t channel);

SRSLTE_API void srslte_vec_prod_cfc2(cf_t *x, float *y, cf_t *z, uint32_t nof_symb, uint32_t nof_prb, uint32_t radio_nof_prb, uint32_t channel);

SRSLTE_API void srslte_vec_prod_cfc3(cf_t *x, float *y, cf_t *z, uint32_t nof_symb, uint32_t nof_prb, uint32_t radio_nof_prb, uint32_t channel, uint32_t guard_band_length);
