...
filename = '/home/zz4fap/work/mcf_tdma/scatter/build/tx_side_assessment_20MHz_1.dat';

fileID = fopen(filename);

phy_bw_idx_to_be_used = 6;
...
sym7_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+7*cpLen_other_symbs(phy_bw_idx_to_be_used)+7*numFFT(phy_bw_idx_to_be_used)+1;
sym7_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+7*cpLen_other_symbs(phy_bw_idx_to_be_used)+8*numFFT(phy_bw_idx_to_be_used);
...
sym8_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+8*cpLen_other_symbs(phy_bw_idx_to_be_used)+8*numFFT(phy_bw_idx_to_be_used)+1;
sym8_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+8*cpLen_other_symbs(phy_bw_idx_to_be_used)+9*numFFT(phy_bw_idx_to_be_used);
...
sym9_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+9*cpLen_other_symbs(phy_bw_idx_to_be_used)+9*numFFT(phy_bw_idx_to_be_used)+1;
sym9_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+9*cpLen_other_symbs(phy_bw_idx_to_be_used)+10*numFFT(phy_bw_idx_to_be_used);
...
sym10_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+10*cpLen_other_symbs(phy_bw_idx_to_be_used)+10*numFFT(phy_bw_idx_to_be_used)+1;
sym10_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+10*cpLen_other_symbs(phy_bw_idx_to_be_used)+11*numFFT(phy_bw_idx_to_be_used);
...
sym11_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+11*cpLen_other_symbs(phy_bw_idx_to_be_used)+11*numFFT(phy_bw_idx_to_be_used)+1;
sym11_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+11*cpLen_other_symbs(phy_bw_idx_to_be_used)+12*numFFT(phy_bw_idx_to_be_used);
...
sym12_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+12*cpLen_other_symbs(phy_bw_idx_to_be_used)+12*numFFT(phy_bw_idx_to_be_used)+1;
sym12_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+12*cpLen_other_symbs(phy_bw_idx_to_be_used)+13*numFFT(phy_bw_idx_to_be_used);
...
sym13_start = cpLen_1st_symb(phy_bw_idx_to_be_used)+13*cpLen_other_symbs(phy_bw_idx_to_be_used)+13*numFFT(phy_bw_idx_to_be_used)+1;
sym13_end = cpLen_1st_symb(phy_bw_idx_to_be_used)+13*cpLen_other_symbs(phy_bw_idx_to_be_used)+14*numFFT(phy_bw_idx_to_be_used);
