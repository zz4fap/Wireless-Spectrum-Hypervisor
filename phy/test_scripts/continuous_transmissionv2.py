...
if __name__ == '__main__':
    ...
    mcs = 0
    gain = 70 # Good value for b200: 30 # for x310 use 200
    num_slots = 1
    seq_number = 0
    num_of_tx = -1
    random_data = generateRandomData(num_slots, bandwidth, mcs)
    ...
    while(True):
        ...
        sendTxCtrlToPhy(lc, channel, bandwidth, mcs, gain, num_slots, seq_number, source_module, random_data, debug)
