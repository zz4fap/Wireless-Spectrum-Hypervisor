...
if __name__ == '__main__':
    ...
    mcs = 0
    tx_gain = 40 # Good value for b200: 30 # for x310 use 200
    rx_gain = 40
    num_of_tx_slots = 1
    num_of_rx_slots = 1
    seq_number = 100
    ...
    while(True):
        ...
        sendTxCtrlToPhy(lc, channel, bandwidth, mcs, tx_gain, num_of_tx_slots, seq_number, source_module, data, debug)
