...
#include <uhd/rfnoc/spec_sense16k_block_ctrl.hpp>
...
class spec_sense16k_block_ctrl_impl : public spec_sense16k_block_ctrl
{
public:
    ...
    UHD_RFNOC_BLOCK_CONSTRUCTOR(spec_sense16k_block_ctrl)
    {
       UHD_LOGGER_INFO("RFNOC") << "spec_sense16k_block::spec_sense16k_block()" << std::endl;

       int default_fft_size = get_arg<int>("fft_size");
       _tree->access<int>(get_arg_path("fft_size/value"))
           .set_coercer(boost::bind(&spec_sense16k_block_ctrl_impl::set_fft_size, this, _1))
           .set(default_fft_size)
       ;

       int default_fft_direction = get_arg<int>("fft_direction");
       _tree->access<int>(get_arg_path("fft_direction/value"))
           .set_coercer(boost::bind(&spec_sense16k_block_ctrl_impl::set_fft_direction, this, _1))
           .set(default_fft_direction)
       ;

       int default_avg_size = get_arg<int>("avg_size");
       _tree->access<int>(get_arg_path("avg_size/value"))
           .set_coercer(boost::bind(&spec_sense16k_block_ctrl_impl::set_avg_size, this, _1))
       ...
       _tree->access<int>(get_arg_path("fft_scaling_sch/value"))
           .set_coercer(boost::bind(&spec_sense16k_block_ctrl_impl::set_fft_scaling_sch, this, _1))
...
private:
    ...
    {
        uint32_t avg_config_word = (avg_size << 14) + fft_size; // only difference between spec_sense and spec_sense16k   avg_size << 16 for spec_sense  TODO change this
    ...
    {
       UHD_RFNOC_BLOCK_TRACE() << "spec_sense16k_block::set_fft_size() : " << fft_size << std::endl;
    ...
    {
       UHD_RFNOC_BLOCK_TRACE() << "spec_sense16k_block::set_avg_size() : " << avg_size << std::endl;
    ...
    {
       UHD_RFNOC_BLOCK_TRACE() << "spec_sense16k_block::set_fft_direction() : " << fft_direction << std::endl;
       int scaling_sch = get_arg<int>("fft_scaling_sch");
       int fft_size = get_arg<int>("fft_size");
    ...
    {
         UHD_RFNOC_BLOCK_TRACE() << "spec_sense16k_block::set_fft_scaling_schedule() : " << scaling_sch << std::endl;
         int fft_size = get_arg<int>("fft_size");
         int fft_direction = get_arg<int>("fft_direction");
         set_fft_ctrl_word(fft_size, fft_direction, scaling_sch);
         return scaling_sch;
...
UHD_RFNOC_BLOCK_REGISTER(spec_sense16k_block_ctrl, "SpecSense16k");
