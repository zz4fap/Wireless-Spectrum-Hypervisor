...
UHD_API uhd_error uhd_usrp_rf_monitor_initialize(
    uhd_usrp_handle h,
    double freq,
    double rate,
    double lo_off,
...
UHD_API uhd_error uhd_usrp_rf_monitor_uninitialize(
    //uhd_usrp_handle h
);

UHD_API uhd_error uhd_usrp_rf_monitor_start(
);

UHD_API uhd_error uhd_usrp_rf_monitor_stop(
);
...
//! Set the given channel's DDC offset
UHD_API uhd_error uhd_usrp_set_rx_channel_freq(
    uhd_usrp_handle h,
    size_t chan,
    double freq
);

//! Get the given channel's central RX frequency
UHD_API uhd_error uhd_usrp_get_rx_channel_freq(
    uhd_usrp_handle h,
    size_t chan,
    double *freq
);
...
//! Set the given channel's DUC offset
UHD_API uhd_error uhd_usrp_set_tx_channel_freq(
    uhd_usrp_handle h,
    size_t chan,
    double freq
);
...
UHD_API uhd_error uhd_usrp_get_tx_channel_freq(
    uhd_usrp_handle h,
    size_t chan,
    double *freq
);
