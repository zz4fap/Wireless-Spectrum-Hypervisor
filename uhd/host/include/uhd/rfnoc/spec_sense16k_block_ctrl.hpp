...
#ifndef INCLUDED_LIBUHD_RFNOC_spec_sense16k_block_ctrl_HPP
#define INCLUDED_LIBUHD_RFNOC_spec_sense16k_block_ctrl_HPP
 ...
 */
class UHD_RFNOC_API spec_sense16k_block_ctrl : public source_block_ctrl_base, public sink_block_ctrl_base
{
public:
    UHD_RFNOC_BLOCK_OBJECT(spec_sense16k_block_ctrl)
...
}; /* class spec_sense_block_ctrl*/

}} /* namespace uhd::rfnoc */

#endif /* INCLUDED_LIBUHD_RFNOC_spec_sense16k_block_ctrl_HPP */
// vim: sw=4 et:
